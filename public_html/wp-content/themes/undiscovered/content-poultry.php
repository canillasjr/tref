...
<section class="blogs-container-odd" id="poultry">
	<div class="row blog-cat-box">
		<div class="category-title">The Cheep, Cheap Chicks Tour</div>
		<div class="row">
			<?php $args = array( 'post_type' => 'post', 'category_name' => 'poultry' , 'posts_per_page' => 3); ?>
