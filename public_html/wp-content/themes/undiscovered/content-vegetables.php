<section class="blogs-container-odd" id="vegetables">
	<div class="row blog-cat-box">
		<div class="category-title">Veggie Trails</div>
		<div class="row">
			<?php $args = array( 'post_type' => 'post', 'category_name' => 'vegetables' , 'posts_per_page' => 3); ?>
