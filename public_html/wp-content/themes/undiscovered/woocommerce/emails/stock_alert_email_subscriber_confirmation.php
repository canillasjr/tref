...
<p><?php printf( __( "Hi there. You have successfully subscribed a product. We will inform you when the product becomes available. Product details are shown below for your reference:", $WOO_Product_Stock_Alert->text_domain ) );
...
?>
<h3><?php _e( 'Product Details', $WOO_Product_Stock_Alert->text_domain ); ?></h3>
...
<h3><?php _e( 'Your Details', $WOO_Product_Stock_Alert->text_domain ); ?></h3>
<p>
	<strong><?php _e( 'Email', $WOO_Product_Stock_Alert->text_domain ); ?> : </strong>
