...
<div id="comments" class="comments-area">
	...
	<?php $comment_args = array(
								...
								'author' => '<p class="comment-form-author"><input placeholder="Name" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>',
										...
										'email'  => '<p class="comment-form-email"><input placeholder="Email Address" id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' />'.'</p>',
...
<a class="arrow-back" href="<?php echo get_permalink(121); ?>">Go Back</a>
</div><!-- #comments -->