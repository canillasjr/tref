<section class="blogs-container-odd" id="buzz">
	<div class="row blog-cat-box">
		<div class="category-title">What’s All The Buzz About?</div>
		<div class="row">
			<?php $args = array( 'post_type' => 'post', 'category_name' => 'bees' , 'posts_per_page' => 3); ?>
